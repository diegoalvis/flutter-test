      ...
      children: <Widget>[
        Row(
          ...
          children: [
            IconButton(
              key: Key('play_button'),
              onPressed: _isPlaying ? (){} : () => _play(),
              iconSize: 70.0,
              icon: Icon(Icons.play_arrow),
              color: _isPlaying ? IdtColors.white : IdtColors.orange,
            ),
            IconButton(
              ...
              color: _isPlaying ? IdtColors.orange : IdtColors.white,
            ),
            IconButton(
              key: Key('stop_button'),
              ...
              color: _isPlaying || _isPaused ? IdtColors.orange : IdtColors.white,
            ),
          ],
        ),
        Column(
              ...
              child: Stack(
                children: [
                  Slider(
                    ...
                    inactiveColor: IdtColors.white.withOpacity(0.7),
