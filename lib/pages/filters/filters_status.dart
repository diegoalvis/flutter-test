...
class FiltersStatus extends ViewStatus {
  ...
  FiltersStatus(
      ...
      required this.openMenuFilter,
      required this.filterSubcategory,
      required this.filterZone,
      required this.filterCategory,
      required this.itemsFilter,
      required this.placesFilter,
      required this.section,
      required this.switchCloseToMe,
      required this.staggedList,
  ...
  FiltersStatus copyWith({
    ...
    List<DataModel?>? filterSubcategory,
    List<DataModel?>? filterZone,
    List<DataModel?>? filterCategory,
    List<DataModel>? itemsFilter,
    List<DataModel>? placesFilter,
    String? section,
    List<StaggeredTile>? staggedList,
    oldFilters,
  }) {
