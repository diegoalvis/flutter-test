...
class IdtColors {
  ...
  static const Color blue = Color(0xff50ACFF);
  static const Color blueDark = Color(0xff266DD1);
  static const Color blueOpac = Color(0xffDAEBF9);
  ...
  static const Color orangeDark = Color(0xFFDC4C1F);
